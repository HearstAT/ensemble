...
ActiveRecord::Schema.define(version: 20170808143450) do
  ...
  create_table "new_relic_applications", force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["new_relic_config_id"], name: "index_new_relic_applications_on_new_relic_config_id"
  end
  ...
  create_table "pager_duty_services", force: :cascade do |t|
    ...
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["pager_duty_config_id"], name: "index_pager_duty_services_on_pager_duty_config_id"
  end
  ...
  create_table "user_business_units", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["business_unit_id"], name: "index_user_business_units_on_business_unit_id"
    t.index ["user_id"], name: "index_user_business_units_on_user_id"
  end
